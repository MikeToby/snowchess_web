...
export default function WorkDetailSheet({
  ...
  const thumbnails = images.map(toWorkThumbPath);
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative h-[92vh] lg:h-auto w-full lg:max-w-6xl overflow-hidden rounded-t-3xl lg:rounded-3xl bg-white shadow-2xl">
              <button
                onClick={onClose}
              ...
              <div className="grid h-full lg:max-h-[88vh] lg:grid-cols-[1.15fr_0.85fr]">
                <div className="relative min-h-[42vh] lg:min-h-[88vh] bg-snow-gray">
                  <Image
